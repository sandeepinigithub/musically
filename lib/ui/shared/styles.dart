...
class Style {
  static heading(var size) => TextStyle(
      fontSize: size / 24.0, fontFamily: 'Gothic', color: Colors.black);

  static headingSmall(var size) => TextStyle(
      fontSize: size / 10.0, fontFamily: 'Gothic', color: Colors.black);
  ...
  static final smallText =
      TextStyle(fontFamily: 'OpenSans', fontSize: 14.0, color: dark);
